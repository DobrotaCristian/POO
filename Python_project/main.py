...
def addsongs():
    ...
    #parcurge fiecare cantec din listă
    for s in temp_song:
        s=s.replace("D:/Python_project/sounds/","")
...
def Play():
    ...
    song=f'D:/Python_project/sounds/{song}'
...
def Previous():
    ...
    temp2=f'D:/Python_project/sounds/{temp2}'
...
def Next():
    ...
    temp=f'D:/Python_project/sounds/{temp}'
...
#Link catre repozitoriu Github
def open_github():
    webbrowser.open_new("https://github.com/DobrotaCristian/POO/tree/main")
...
height = 12, width = 47, selectbackground = "purple", selectforeground = "black")
...
my_menu.add_command(label = "GitHub", command = open_github)
